...
export function validateParams(p) {
  ...
  if (!Number.isFinite(amount) || amount < LIMITS.minAmount || amount > LIMITS.maxAmount)
    throw new PlanError(`amount must be between ${LIMITS.minAmount} and ${LIMITS.maxAmount} USDC`)
